...
const EditProfile = () => {
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                const response = await axios.get('http://localhost:5000/api/coaches/coachProfile', {
                    headers: {
    ...
    const handleEditProfile = async (e) => {
        ...
        try {
            const response = await axios.put(
                'http://localhost:5000/api/coaches/edit-profile',
    ...
    const handleChangePassWord = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.put('http://localhost:5000/api/coaches/change-password', {
