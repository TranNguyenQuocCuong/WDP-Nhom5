            ...
            <div className="footer container-fluid mt-5 py-5 px-sm-3 px-md-5 text-white">
                <div className="row pt-5">
                    <div className="footer-nav col-lg-3 col-sm-6 mb-5 ps-sm-5 ps-lg-0">
                        ...
                        <p><i className="fa fa-map-marker-alt me-2"></i>Hoa Hai, Ngu Hanh Son, Da Nang</p>
                        <p><i className="fa fa-phone-alt me-2"></i>+012 345 67890</p>
                        <p><i className="fa fa-envelope me-2"></i>fitzoneteams@gmail.com</p>
                    ...
                    <div className="footer-info col-lg-3 col-sm-6 mb-5">
                        ...
                        <p>05:00 AM - 08:00 PM</p>
                        <h5 className="text-white">Saturday - Sunday</h5>
                        <p>06:30 PM - 09:30 PM</p>
                    </div>
                </div>
                <div className="container border-top border-dark pt-5">
                    <p className="m-0 text-center text-white">
                        &copy; <Link className="text-white fw-bold text-decoration-none" to="/">FitZone</Link>. All Rights Reserved. Designed by
                        <Link className="text-white fw-bold text-decoration-none" to="/"> FitZone Teams</Link>
                    </p>
                </div>
            </div>
